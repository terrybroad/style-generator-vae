#style based generator code taken and adapted from: https://github.com/rosinality/style-based-gan-pytorch
    ...
    def forward(self, input, noise=None, step=0, alpha=-1, mean_style=None, style_weight=0, mixing_range=(-1, -1)):
        ...
        if noise is None:
            ...
            for i in range(step + 1):
                size = 4 * 2 ** i
                #turn off noise for training VAE
...
class Encoder(nn.Module):
    ...
    def encode(self, input, step, alpha):
    ...
    def forward(self, input, step=0, alpha=-1):
        ...
        return z, kld #, self.linear(z) gan discriminator function
